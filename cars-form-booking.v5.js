$(document).ready(function () {
              ...
              <div class="needs-validation row g-3 mt-2">
                ...
                <div class="col-md-6 align-self-end">
                  <select class="form-control" id="slot_time" required placeholder="Time">
                    <option value="1" selected>10:00 am - 10:30 am</option>
                    ...
                    <option value="7">01:00 pm - 01:30 pm</option>
                    <option value="8">01:30 pm - 02:00 pm</option>
                    <option value="9">02:00 pm - 02:30 pm</option>
                    <option value="10">02:30 pm - 03:00 pm</option>
                    <option value="11">03:00 pm - 03:30 pm</option>
                    <option value="12">03:30 pm - 04:00 pm</option>
                    <option value="13">04:00 pm - 04:30 pm</option>
                    <option value="14">04:30 pm - 05:00 pm</option>
                    <option value="15">05:00 pm - 05:30 pm</option>
                    <option value="16">05:30 pm - 06:00 pm</option>
                    <option value="17">06:00 pm - 06:30 pm</option>
                    <option value="18">06:30 pm - 07:00 pm</option>
                    <option value="19">07:00 pm - 07:30 pm</option>
                    <option value="20">07:30 pm - 08:00 pm</option>
                    <option value="21">08:00 pm - 08:30 pm</option>
                  </select>
                </div>
    ...
    function isFridaySelected(datepicker) {
        // Get the selected date from the datepicker
        var selectedDate = $(datepicker).datepicker("getDate");

        // Check if the day of the week is Friday (index 5)
        return selectedDate.getDay() === 5;
    }

    function hideOptions(valuesToHide) {
        $("#slot_time option").each(function () {
            if ($.inArray(parseInt($(this).val()), valuesToHide) !== -1) {
                $(this).hide();
            } else {
                $(this).show();
            }
    ...
    function selectTimeSlot(value) {
        var timeElement = document.getElementById("slot_time");
        if (!!timeElement) timeElement.value = value;
    }
    ...
    var holidayDates = ["09-04-2024", "10-04-2024", "11-04-2024"];
    var getMinDate = () => {
        var today = new Date();
        var formattedToday = customDateFormat(today);
      
        if(holidayDates.includes(formattedToday)) {
            return  new Date(2024, 3, 12);
        } else {
            return  today;
        }
    };
    ...
    if ($("#datepicker").length > 0) {
        ...
        $("#datepicker").on('change', function (evt) {
            let isFriday = isFridaySelected(evt.target);
            var valuesToHideOnFriday = [1, 2, 3, 4, 5, 6, 7, 8]; // Array of values to hide
            var valuesToHideOnNonFriday = [20, 21]; // Array of values to hide
            if (isFriday) {
                hideOptions(valuesToHideOnFriday);
                selectTimeSlot(9);
            } else {
                hideOptions(valuesToHideOnNonFriday);
                selectTimeSlot(1);
            }
        });
        $("#datepicker").datepicker("setDate", getMinDate()).datepicker("fill");
    }
